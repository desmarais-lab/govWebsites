...
\begin{figure}[!ht]
	\centering % Using \begin{figure*} makes the figure take up the entire width of the page
	\caption{Top democratic and Republican words (Indiana), according to the informed Dirichlet model of Monroe et al. (2008).}
	\label{fightinwords}
...
\begin{figure}[!ht]
	\centering % Using \begin{figure*} makes the figure take up the entire width of the page
	\caption{Top democratic and Republican words (Louisiana), according to the informed Dirichlet model of Monroe et al. (2008).}
	\label{fightinwordsLA}
	\includegraphics[width=\linewidth]{figures/fightinWordsLA.png}
\end{figure}

%Partisan top words - topic model
\input{tables/partisanTopWords.tex}

%Partisan top words - fightin words
\input{tables/fightinwords.tex}

%Partisan top words - topic model
\input{tables/partisanTopWordsLA.tex}

%Partisan top words - fightin words
\input{tables/fightinwordsLA.tex}
