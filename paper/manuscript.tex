...
The results are shown in table \ref{stmResultsTable}. The rows of the table are sorted so that the most Republican topics (marked by a deeper red color) appear at the top, and the most Democratic ones (blue) at the bottom [@markus, would you please add a sentence indicating how we measured how R/D a topic was (e.g., the magnitude of the coefficient)?]. The topics that are entirely white have 90\% credible intervals on the effect of mayoral party that include zero. 
