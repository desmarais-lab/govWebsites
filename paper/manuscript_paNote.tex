...
\begin{table}[ht]
    ...
    \begin{tabular}{lrr}
        ...
        3. Lemmatize text. & \texttt{spacyr} \citep{spacyr}& yes \\
        4. Remove names. & \texttt{spacyr} & yes \\
        5. Retain nouns, verbs, adjectives. & \texttt{spacyr} & yes \\
        6. Stopword/number/0-2 character word removal. & \texttt{quanteda} \citep{quanteda} & yes \\ 
        7. Retain tokens that are English words. & \texttt{Hunspell} \citep{hunspell} & yes \\
        8. Removal of duplicate documents. & \texttt{gov2text} & yes \\
        \hline
    \end{tabular}
