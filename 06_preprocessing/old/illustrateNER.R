...
#make a dataframe which shows off the words per entity, sorted by count
#put everything in a list
testt <- list()
test = aggregate(parsedtxt$token, by = list(parsedtxt$entity), FUN = paste, collapse = " ")
test <- test[!test$Group.1=="LANGUAGE_B",]
...
print(xtable(gg), type = "html", file = "out/NERTest.html")
